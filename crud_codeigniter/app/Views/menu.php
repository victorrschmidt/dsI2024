...
<body>
            ...
            <div id="header-content" class="container-fluid">
                ...
                <section id="header-right-content" class="collapse navbar-collapse">
                    <ul id="header-right-content-list" class="navbar-nav">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>menu" class="link-active d-flex align-items-center">
                                <span class="material-symbols-outlined header-icon">menu_book</span>
                                <p class="m-0">Livros disponíveis</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>meus_livros" class="d-flex align-items-center">
    ...
    <main class="container py-3">
        ...
        <?php } ?>
        <form method="GET" action="<?php echo base_url(); ?>menu" id="form-ordem" class="mb-4">
        ...
        <form method="GET" action="<?php echo base_url(); ?>menu" class="mb-4 d-flex align-items-end">
            <div class="w-25">
            ...
            <table id="tabela-livros" class="table table-striped border border-2">
                ...
                <?php foreach ($LIVROS as $livro) { ?>
                    <tr valign="middle">
                        ...
                        <td>
                            <form method="POST" action="<?php echo base_url(); ?>alugar_livro">
                                <input name="alugar_livro" value="<?php echo $livro['id']; ?>" type="hidden">  
